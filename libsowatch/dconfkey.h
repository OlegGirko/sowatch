#ifndef SOWATCH_DCONFKEY_H
#define SOWATCH_DCONFKEY_H
...
class SOWATCH_EXPORT DConfKey : public ConfigKey
{
	Q_OBJECT

public:
	DConfKey(const QString& key = QString(), QObject *parent = 0);
	~DConfKey();
